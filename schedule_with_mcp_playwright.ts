...
// Script to schedule 150 Facebook group posts using the existing Playwright browser session
// This script assumes we're already on the group page: https://www.facebook.com/groups/tokeniza
// And that we're logged in as Netto Farias
...
const CONFIG = {
  ...
  delayBetweenPosts: 8000, // 8 seconds between posts
...
async function schedulePost(postIndex) {
...
async function main() {
  console.log('🚀 Iniciando agendamento de posts para Facebook usando sessão existente...');
